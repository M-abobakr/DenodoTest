            ...
            steps {
                script {
                   ...
                   // def jsonSlurper = new JsonSlurper()
                    def revisionCreationResponse = bat(returnStdout: true, script: "curl -u admin:admin -d \"{\\\"name\\\":\\\"jenkins_revision\\\"}\" -H \"Content-Type:application/json\" -X POST http://kubernetes.docker.internal:10090/revisions/loadFromVQL")
                    println("respoooonse")
